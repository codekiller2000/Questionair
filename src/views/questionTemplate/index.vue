...
<!--      </el-form-item>-->
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border
      ...
      <el-table-column sortable prop="id" label="问题id">
      </el-table-column>


      <el-table-column sortable prop="templateName" label="模板名称" width="400" show-overflow-tooltip>
      </el-table-column>
    ...
    <el-dialog :title="handleStatus === 1?'添加':handleStatus === 2?'修改':'查看'" :visible.sync="editFormVisible"
      ...
      <el-form label-width="120px" :model="editForm" :rules="rules" ref="editForm">
        ...
        <el-form-item label="模板名称" prop="templateName">
          <el-input size="small" v-model="editForm.templateName" auto-complete="off"
                    placeholder="输入模板名称"></el-input>
        </el-form-item>
    ...
    submitForm(formRefsName) {
      this.$refs[formRefsName].validate(valid => {
        ...
        if (this.handleStatus === 1) {
          templateSave(this.editForm).then(res => {
          ...
          templateEdit(this.editForm,this.editForm.id).then(res => {
            this.editFormVisible = false
            this.loading = false
            if (res.data.code === "000000") {
              this.getData()
